...
namespace Mitsuba {
	class MeshStore {
        ...
        protected void StoreSerialized(Mesh mesh, string name) {
        ...
        protected void StoreOBJ(Mesh mesh, string name) {
            Log("Not implemented yet: storing as OBJ");
        }
